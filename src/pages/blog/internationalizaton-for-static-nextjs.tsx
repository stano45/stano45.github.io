...
`;
  ...
  return (
    <BlogPost post={blogPost}>
      <h2 className="my-8 text-xl font-bold">Background</h2>
      <div className="my-8">
      ...
      <div className="mb-8">
        ...
        website doesn't require any network calls, so it's possible to statically generate the content (SSG). GitHub
        ...
        for actions that handles everything for you; all you need to do is push the code to your repo, and voila, it's
        up and running.
      </div>
      <div className="mb-8">
        ...
        <strong> sub-domain</strong>. The user's preferred language will be detected automatically (if enabled), and
        they will be redirected accordingly. For instance, a user with French as their preferred language would be
        redirected from example.com to example.com/fr (sub-path) or example.fr (sub-domain).
      </div>
      <div className="mb-8">
        However, Next.js doesn't provide the actual management of translations and hooks to integrate them into your
        application. Fortunately, there's a library specifically designed for this purpose:{' '}
      ...
      <h2 className="my-8 text-xl font-bold">The catch</h2>
      <div className="mb-8">
      ...
      <CopyBlock text={component} language={'typescript'} theme={dracula} showLineNumbers wrapLines />
