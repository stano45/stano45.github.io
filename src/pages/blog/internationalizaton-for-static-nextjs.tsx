	...
	return (
		<BlogPost post={internationalizationPost}>
			...
			<div className="my-8 text-xl">
				...
				top right of the website, which would switch the top navbar’s strings to
				the translated versions.
			</div>
			<div className="mb-8 text-xl">
				I chose a tech stack for my website that was both simple and flexible in
				terms of styling: <strong>Next.js</strong> with{" "}
				...
				for actions that handles everything for you; all you need to do is push
				the code to your repo, and voila, it&apos;s up and running.
			</div>
			<div className="mb-8 text-xl">
				...
				). With a few config files, your site will automatically redirect users
				to the appropriate <strong>sub-path</strong> or
				<strong> sub-domain</strong>. The user&apos;s preferred language will be
				detected automatically (if enabled), and they will be redirected
			...
			<div className="mb-8 text-xl">
				...
				. With just a couple of lines of code, this library allows you to easily
				set up localization. There is a catch, though.
			</div>
			<h2 className="my-8 text-3xl font-bold">The catch</h2>
			<div className="mb-8 text-xl">
				As I mentioned earlier, we want to statically generate our site content.
				However, next-i18n provides translations via server-side rendering
				(SSR), which makes it impossible to export the site statically since we
			...
			<div className="mb-8 text-xl">
				...
				to address this exact issue. It provides convenient internationalization
				with a useTranslation hook, exactly as with i18next, but does not rely
				on SSR. It achieves this by saving the localization as a query parameter
			...
			<div className="mb-8 text-xl">
				...
				readme of their repo. However, I want to show how I integrated this into
				my site.
			</div>
			<div className="mb-8 text-xl">
			...
			<div className="mb-8 text-xl">
				...
				server-side rendering. The library allows convenient localization with a
				useTranslation hook and saves the localization as a query parameter
				instead of using sub-paths or sub-domains.
			</div>
